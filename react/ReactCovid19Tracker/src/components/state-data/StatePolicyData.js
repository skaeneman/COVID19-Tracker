  ...
  return (
    <div>
        <Card className="text-left" bg="light" text='dark'>
          <Card.Header className="alert alert-dark">State Info</Card.Header>
          <Card.Body>
            <Card.Text as="span">
            <div>
              {/* <Row>
              ...
              <Row>
                <Col xs="6" className="text-left">State:</Col>
                <Col className="text-left">{ props.stateData.stateName }</Col>
              </Row>    
              <Row>
                <Col xs="6" className="text-left">K to 12 Schools Closed:</Col>
                <Col className="text-left">{ props.stateData.k12SchoolsClosed }</Col>
              </Row>  
              <Row>
                <Col xs="6" className="text-left">Shelter In Place Starts:</Col>
                <Col className="text-left">{ props.stateData.shelterInPlaceStart }</Col>
              </Row>  
              <Row>
                <Col xs="6" className="text-left">Shelter In Place End:</Col>
                <Col className="text-left">{ props.stateData.shelterInPlaceEnd }</Col>
              </Row>  
              <Row>
                <Col xs="6" className="text-left">State Of Emergency:</Col>
